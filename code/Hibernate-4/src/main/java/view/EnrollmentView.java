    ...
    public EnrollmentView() throws Exception {
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                ActivityService.addActivity("Added new enrollment");
        ...
        btnRemove.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                int enrollmentIdText = Integer.valueOf(enrollmentId.getText());
                EnrollmentService.removeEnrollment(enrollmentIdText);
                ActivityService.addActivity("Deleted enrollment");
                try {
                    table.setModel(TableService.readTableEnrollments());
                } catch (Exception e1) {
                    // TODO Auto-generated catch block
        ...
        btnUpdate.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                ActivityService.addActivity("Updated enrollment");
